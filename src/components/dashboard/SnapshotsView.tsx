    ...
    <div className="space-y-4 animate-fade-in">
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        <div className="relative w-full md:w-96">
          ...
          <Input 
            className="bg-zinc-900 border-white/10 pl-10 text-xs font-mono" 
            placeholder="Search by ID or Hash..." 
          />
        </div>
        <div className="flex items-center gap-2 w-full md:w-auto">
          <Button variant="outline" size="sm" className="bg-zinc-900 border-white/10 text-xs font-mono h-9">
            <Filter className="w-3.5 h-3.5 mr-2" /> Filter
          </Button>
          <Button variant="outline" size="sm" className="bg-emerald-600 hover:bg-emerald-500 border-none text-white text-xs font-mono h-9">
            Create Snapshot
          </Button>
        </div>
      </div>
          ...
          <TableBody>
            {snapshots.map((s) => (
              <TableRow key={s.id} className="border-white/5 hover:bg-zinc-800/40 transition-colors">
                ...
                <TableCell className="font-mono text-[10px] text-zinc-500">{s.hash}</TableCell>
                <TableCell className="text-right">
                  <div className="flex items-center justify-end gap-2">
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-400 hover:text-emerald-500">
      ...
      <div className="flex items-center justify-between px-2">
        <p className="text-[10px] font-mono text-zinc-600">Showing 6 of 142 snapshots</p>
        <div className="flex gap-2">
           <Button variant="outline" size="sm" className="h-7 px-2 text-[10px] bg-zinc-900 border-white/5">Prev</Button>
           <Button variant="outline" size="sm" className="h-7 px-2 text-[10px] bg-zinc-900 border-white/5">Next</Button>
        </div>
      </div>
    </div>
  );
